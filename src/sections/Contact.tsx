...
export default function Contact() {
  ...
  return (
    <Section id="contact" className="border-t border-white/5 scroll-mt-20">
      <Container>
        <Grid cols={12} gap={12}>
          ...
          <div className="lg:col-span-5 flex flex-col justify-between text-left">
            <div>
              ...
              <motion.h2
                ...
                className={`${typography.headingXL} text-white mb-8`}
              >
                {t("title")}
              </motion.h2>
              <motion.p
                ...
                className="text-[#9B9B9B] leading-relaxed mb-12 text-base"
              >
                {t("subtitle")}
              </motion.p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 group">
                <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 group-hover:border-[#D4AF37]/30 text-[#9B9B9B] group-hover:text-[#D4AF37] transition-all">
                  <Icon name="phone" className="w-5 h-5" />
                </div>
                <div>
                  <div className="text-xs uppercase tracking-wider text-[#9B9B9B] font-semibold mb-0.5">Call Us</div>
                  <a href="tel:+15125550199" className="text-white hover:text-[#D4AF37] font-medium transition-colors">(512) 555-0199</a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <a href="mailto:info@canitoconstruction.com" className="text-white hover:text-[#D4AF37] font-medium transition-colors">info@canitoconstruction.com</a>
                </div>
              </div>
          ...
          <div className="lg:col-span-7">
            <motion.div
              ...
              viewport={{ once: true }}
              variants={fadeUp(0, 0.6)}
              className="p-8 sm:p-12 rounded-3xl border border-white/5 bg-white/[0.01] backdrop-blur-sm relative"
            >
